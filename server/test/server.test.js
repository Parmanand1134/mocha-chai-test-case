...
const { todos, addDummyTodoItems, users, addDummyUsers, addDummyCustomer } = require('./seed/seed')
    ...
    request(app)
      ...
      .expect((res) => {
        if (res && res.body && res.body.data) {
          ...
          console.log("boyyyyyyyyyyyy", res.body);
        }
      })
      .end((err) => {
        if (err) return done(err);
        done(); // Call done() here to indicate that the test is complete
      });
